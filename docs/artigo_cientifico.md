...
1. `field1`..`field4` — grandezas analógicas (temperatura, umidade, luminosidade e tensão AC);
2. `field5`..`field7` — estados discretos (movimento, fonte de energia e alarme);
3. `field8` — tempo de atividade (*uptime*) do dispositivo;
